          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="mt-1 w-full border border-gray-300 rounded-lg px-4 py-2.5 pr-11 focus:outline-none focus:ring-2 focus:ring-orange-400 transition-shadow duration-200"
                required
              />
              <button
                type="button"
