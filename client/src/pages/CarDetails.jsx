...
function CarDetails() {
  ...
  return (
    <div className="px-6 md:px-12 py-10 max-w-5xl mx-auto bg-gray-50 min-h-screen">
      <Link to="/cars" className="text-sm text-gray-500 hover:text-orange-500 transition-colors duration-200">← Back to Cars</Link>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-6">
        <div>
         <div className="h-64 bg-gray-100 rounded-2xl shadow-sm flex items-center justify-center text-7xl overflow-hidden">
 {car.image ? (
  <img
    src={car.image}
